  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await fetch(WEBHOOK_URL, {
        ...
        body: JSON.stringify({ form_name: "contact", source: "gluelammanufacturerinsurance.com", ...formData }),
      });
      setSubmitted(true);
    } catch {
            ...
            <FadeIn>
              ...
              <h1 className="mt-5 font-heading font-extrabold text-espresso text-4xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight">
                ...
                <span className="bg-gradient-to-r from-clay via-clay-light to-gold-dark bg-clip-text text-transparent">
                  glulam manufacturing coverage
                </span>
              </h1>
              <p className="mt-5 lead max-w-2xl mx-auto">
                Questions, a quote, or a claim — reach a person who knows timber manufacturing, not a queue.
              </p>
            </FadeIn>
          </div>
        </section>
                ...
                >
                  ...
                  <div className="grid sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <input id="phone" name="phone" type="tel" value={formData.phone} onChange={handleChange} placeholder="(503) 555-0100" className={inputClass} />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <textarea id="message" name="message" rows={5} required value={formData.message} onChange={handleChange} placeholder="Tell us about your operation or question…" className={`${inputClass} resize-none`} />
                  </div>
