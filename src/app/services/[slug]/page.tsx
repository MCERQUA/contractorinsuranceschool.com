...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${service.title} for Glulam Manufacturers`,
    description: service.description,
    keywords: service.keywords ? [...service.keywords] : undefined,
    alternates: { canonical: url },
    openGraph: {
      title: `${service.title} for Glulam Manufacturers | Contractors Choice Agency`,
      description: service.description,
      url,
    },
  };
...
export default async function ServiceDetailPage({ params }: Props) {
  ...
  const serviceSchema = {
    ...
    name: `${service.title} for Glulam Manufacturers`,
    description: service.description,
    url,
    provider: {
    ...
    category: "Manufacturer Insurance",
  };
            ...
            <div className="grid lg:grid-cols-12 gap-10 items-center">
              ...
              <FadeIn direction="left" className="lg:col-span-5">
                <div className="rounded-t-[10rem] rounded-b-3xl overflow-hidden border-4 border-white shadow-warm-lg">
                  <img
                    src="/images/hero.jpg"
                    alt={`${service.title} — glulam manufacturing`}
