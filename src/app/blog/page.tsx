...
export const metadata: Metadata = {
  title: "Glulam Manufacturer Insurance Blog — Guides & Insights",
  description:
    "Practical insurance guidance for glulam timber manufacturers: products liability, workers' comp for mill crews, commercial property, inland marine for oversized beams.",
  alternates: { canonical: `${SITE.url}/blog` },
  openGraph: {
    title: "Glulam Manufacturer Insurance Blog | Contractors Choice Agency",
    description:
      "Practical insurance guidance for glulam timber manufacturers: products liability, workers' comp for mill crews, commercial property, inland marine for oversized beams.",
    url: `${SITE.url}/blog`,
  },
          ...
          <div className="container-tight text-center">
            <FadeIn>
              ...
              <p className="mt-5 lead max-w-2xl mx-auto">
                Plain-English guides on the coverage that matters for timber manufacturers —
                products liability, workers' comp for mill crews, commercial property, and inland marine for oversized beams.
              </p>
            </FadeIn>
          </div>
        </section>
                    ...
                    <Link href={`/blog/${featured.slug}`} className="group block">
                      <article className="grid md:grid-cols-2 gap-0 rounded-[2rem] overflow-hidden bg-white border border-adobe shadow-card hover:shadow-card-hover transition-all">
                        <div className="relative overflow-hidden">
                          <img
                            src={featured.image || "/images/glulam-beams.jpg"}
                            alt={featured.title}
