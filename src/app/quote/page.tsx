...
const WEBHOOK_URL =
  "https://josh.jam-bot.com/social-api/api/leads/webhook/netlify?tenant=josh&site=gluelammanufacturerinsurance.com";

const trustItems = [
  { icon: ShieldCheck, title: "Built for glulam", desc: "Policies written for timber manufacturers — not generic manufacturing coverage." },
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      await fetch(WEBHOOK_URL, {
        ...
        body: JSON.stringify({ form_name: "quote", source: "gluelammanufacturerinsurance.com", ...formData }),
      });
      setSubmitted(true);
    } catch {
            ...
            <FadeIn className="text-center max-w-2xl mx-auto mb-12">
              ...
              <h1 className="mt-5 font-heading font-extrabold text-espresso text-4xl md:text-5xl lg:text-6xl leading-[1.05] tracking-tight">
                ...
                <span className="bg-gradient-to-r from-clay via-clay-light to-gold-dark bg-clip-text text-transparent">
                  glulam manufacturer insurance quote
                </span>
              </h1>
              <p className="mt-5 lead">
                Tell us about your plant. We'll shop A-rated specialty markets and
                come back with real quotes in about 15 minutes — no obligation.
              </p>
            </FadeIn>
                  ...
                  <FadeIn>
                    <div className="p-10 md:p-12 rounded-3xl bg-white border border-adobe shadow-card text-center">
                      ...
                      <p className="text-mocha mb-2">
                        Thank you! We'll review your operation and reach out within one
                    ...
                    >
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <input id="businessName" name="businessName" type="text" required value={formData.businessName} onChange={handleChange} placeholder="Pacific Northwest Glulam LLC" className={inputClass} />
                        </div>
                      </div>
                      ...
                      <div className="grid sm:grid-cols-2 gap-4">
                        <div>
                          ...
                          <input id="email" name="email" type="email" required value={formData.email} onChange={handleChange} placeholder="jane@cascadiaglulam.com" className={inputClass} />
                        </div>
                        <div>
                          <label htmlFor="phone" className={labelClass}>Phone *</label>
                          <input id="phone" name="phone" type="tel" required value={formData.phone} onChange={handleChange} placeholder="(503) 555-0100" className={inputClass} />
                        </div>
                      </div>
                      ...
                      <div>
                        ...
                        <textarea
                          ...
                          onChange={handleChange} placeholder="Plant size, production volume, equipment value, coverage lines needed, current insurer, loss history, or anything else that helps us quote accurately…"
                      ...
                      <p className="text-xs text-center text-mocha/70">
                        No spam. No commitment. We'll only contact you about your quote.
                      </p>
                    </form>
                  </FadeIn>
                )}
