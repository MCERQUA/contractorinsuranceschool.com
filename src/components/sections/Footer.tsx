...
import { Phone, Mail, MapPin, Clock, Layers, ShieldCheck } from "lucide-react";
        ...
        <div className="container-wide py-10 flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <p className="font-heading font-bold text-2xl text-cream">
              Ready to protect your glulam operation?
            </p>
            <p className="text-cream/70 mt-1">
              15-minute quotes. 2-hour claims response. Insurance for glue-laminated timber manufacturers nationwide.
            </p>
          </div>
      ...
      <div className="container-wide py-14 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8">
        <div className="col-span-2 lg:col-span-2">
          ...
          <p className="text-cream/70 text-sm leading-relaxed max-w-sm">
            Specialized insurance for glue-laminated timber manufacturers — products liability, commercial property, workers' comp, and inland marine. A division of Contractors Choice Agency — founded 2005, licensed all 50 states.
          </p>
