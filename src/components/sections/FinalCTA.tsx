      ...
      <div className="container-tight relative text-center">
        <FadeIn>
          ...
          <h2 className="mt-6 font-heading font-extrabold text-cream text-3xl md:text-5xl leading-[1.1]">
            Protect Your Glulam Operation{" "}
            <span className="text-gold-light">with coverage built for timber.</span>
          </h2>
          <p className="mt-5 text-cream/90 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
            Whether you need products liability today or a full program — property, workers' comp, transit, and umbrella — one call gets you real quotes from specialty timber markets. Not a voicemail and a two-week wait.
          </p>
