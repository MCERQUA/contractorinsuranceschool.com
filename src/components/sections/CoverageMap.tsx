        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <FadeIn>
            ...
            <h2 className="mt-3 h-section">
              Timber manufacturing coverage.{" "}
              <span className="text-clay">All 50 states.</span>
            </h2>
            <p className="mt-4 lead">
              From Pacific Northwest Douglas-fir mills to Southeast SYP glulam producers, Contractors Choice Agency writes glulam manufacturer insurance in every state where timber manufacturing operates.
            </p>
          ...
          <FadeIn direction="left">
            <div className="relative rounded-t-[12rem] rounded-b-3xl overflow-hidden border-4 border-white shadow-warm-lg">
              <img
                src="/images/architectural-glulam.jpg"
                alt="Completed building with exposed glue-laminated timber beams — national glulam manufacturing coverage"
              ...
              <div className="absolute bottom-0 inset-x-0 p-7">
                <p className="font-heading font-extrabold text-cream text-2xl leading-tight">
                  National coverage for timber manufacturers.
                </p>
                <p className="text-cream/80 text-sm mt-1">
                  Writing glulam manufacturer programs in all 50 states since 2005.
                </p>
