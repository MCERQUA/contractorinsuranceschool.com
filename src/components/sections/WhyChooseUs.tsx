        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-start">
          ...
          <FadeIn className="lg:col-span-5 lg:sticky lg:top-28">
            ...
            <h2 className="mt-3 h-section">
              ...
              <span className="text-clay">cost glulam manufacturers</span> the most.
            </h2>
            <p className="mt-4 lead">
              Most agents hand a glulam plant a generic manufacturer policy and call it
              done. Then a delamination or dust-fire claim hits and the exclusion kicks in.
              We underwrite the parts of your operation everyone else leaves out.
            </p>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-heading font-bold text-espresso">
                    Run by people who know manufacturing
                  </p>
                  <p className="text-sm text-mocha mt-1 leading-relaxed">
                    Contractors Choice Agency was founded in 2005 by people from the trades.
                    We've walked plant floors, read the ANSI A190.1 specs, and know what a
                    hydraulic press or dry kiln costs to replace.
                  </p>
                </div>
              </div>
            </div>
